...
#### 删除机场：超级跑车（已跑路）、美汁源（机场主摆烂）、Futrue Network未来网络（使用体验不理想）、Uni Cloud（机场总是被攻击，因此删除）、xsus养鸡场（2023年7月遭遇重大情况，使用体验不友好）、Godetia（价格过高，不符合本仓库搜录）、Freejump（价格不是太性价比，节点地区少）、色色小站、ACA（机场停止注册新购，因此删除）、SOCK BOOM 已跑路
------
