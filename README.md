...
#### 删除机场：超级跑车（已跑路）、美汁源（机场主摆烂）、Futrue Network未来网络（使用体验不理想）、Uni Cloud（机场总是被攻击，因此删除）、xsus养鸡场（2023年7月遭遇重大情况，使用体验不友好）、Godetia（价格过高，不符合本仓库搜录）、Freejump（价格不是太性价比，节点地区少）、色色小站、ACA（机场停止注册新购，因此删除）
------
...
> 使用体验(2024年1月4日)：最近又回到这个机场使用了半个月，除了原单价因香港带宽成本上升而不得已提升套餐价格外，使用体验还是如我最开始碰到这家的使用体验一致，十分丝滑
...
| ---------------- | ----------------- | ------------------ | ---------------- |
| 50G              | 11.99R / 月        | 不限速             | 不限             |
| 150G             | 19.99R  / 月      | 不限速             | 不限             |
| 300G             | 29.99R / 月       | 不限速             | 不限             |
### 流量包价格及速率
